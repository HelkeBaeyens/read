...
def search_unknown(filename, dictionary):
	...
	for word in words:
		if word in dictionary:
			...
			unknowns.remove(word)
		elif word[-5:] == 'tting' or word[-5:] == 'ation':
			if word[:-5] in dictionary:
				unknowns.remove(word)
			elif word[:-4] in dictionary:
				unknowns.remove(word)
		elif word[-4:] == 'ment' or word[-4:] == 'ness' or word[-4:] == 'ship' or word[-4:] == 'less' or word[-4:] == 'able' or word[-4:] == 'ance': 
	...
	for word in words:
		if word[-3:] == 'ing' or word[-3:] == 'dom' or word[-3:] == 'ize' or word[-3:] == 'ise' or word[-3:] == 'ism'or word[-3:] == 'ful' or word[-3:] == 'ish'or word[-3:] == 'ary'or word[-3:] == 'ate'or word[-3:] == 'ade':
			if word[:-3] in dictionary:
				unknowns.remove(word)
		elif word[-2:] == 'es' or word[-2:] == 'ly' or word[-2:] == 'en' or word[-2:] == 'or' or word[-2:] == 'en' or word[-2:] == 'al' or word[-2:] == 'ed' or word[-2:] == 'er' :
			if word[:-2] in dictionary:
				unknowns.remove(word)
	for word in unknowns:
		if word [-1:] == 's' or word[-1:] == 'y' or word[-1:] == 'd' or word[-1:] ==',' or word == '?':
	...
	for word in words: 
		if word [:7] == 'counter':
			...
			if word[6:] in dictionary:
				unknowns.remove(word)
		elif word[:5] == 'extra' or word[:5] == 'hyper' or word[:5] == 'intra' or word[:5] == 'trans' or word[:5] == 'ultra' or word[:5] == 'onder' or word[:5] == 'super' :
			if word[5:] in dictionary:
				unknowns.remove(word)
		elif word[:4] == 'ante' or word[:4] == 'anti' or word[:4] == 'hemi' or word[:4] == 'hypo' or word[:4] == 'peri' or word[:4] == 'semi' or word[:4] == 'over' or word[:4] == 'post' or word[:4] == 'auto' or word[:4] == 'mega':
			if word[4:] in dictionary:
				unknowns.remove(word)
		elif word[:3] == 'dis' or word[:3] == 'non' or word[:3] == 'pre' or word[:3] == 'pro' or word[:3] == 'sub' or word[:3] == 'sup' or word[:3] == 'mis':
			if word[3:] in dictionary:
				unknowns.remove(word)
		elif word[:2] == 'un' or word[:2] == 'in' or word[:2] == 'im' or word[:2] == 're' or word[:2] == 'an' or word[:2] == 'af' or word[:2] == 'al' or word[:2] == 'be' or word[:2] == 'co' or word[:2] == 'ex' or word[:2] == 'en' or word[:2] == 'up':   
			if word[2:] in dictionary:
				unknowns.remove(word)
		elif word[:1] == 'a' or word[:1] == 'e':
			if word[1:] in dictionary:
				unknowns.remove(word)
		else:
			None
