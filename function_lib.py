...
def search_unknown(filename, dictionary):
	...
	words = filename.lower().replace('?', ' ').replace('!',' ').replace('.',' ').replace('-',' ').replace(':',' ').replace(';',' ').replace(',',' ').replace('(',' ').replace(')',' ').replace('[',' ').replace(']',' ').replace('"',' ').replace("'",' ').split(' ')
	unknowns = list(words)
	...
	for word in words:
		if word[-5:] == 'tting' or word[-5:] =='nning' or word[-5:] == 'pping' or word[-5:] == 'mming' or word[-5:] == 'rring' or word[-5:] == 'lling' or word[-5:] == 'bbing' or word[-5:] == 'ation':
			...
			if word[:-4]+'e' in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-5] in dictionary and word in unknowns:
				unknowns.remove(word)
		if word[-4:] == 'tted' or word[-4:] == 'rred' or word[-4:] == 'lled' or word[-4:] == 'bbed' or word[-4:] == 'gged' or word[-4:] == 'pped':
			if word[:-3] in dictionary and word in unknowns:
				unknowns.remove(word) 
			if word[:-3] +'e' in dictionary and word in unknowns:
				unknowns.remove(word)
		if word[-4:] == 'ment' or word[-4:] == 'ness' or word[-4:] == 'ship' or word[-4:] == 'less' or word[-4:] == 'able' or word[-4:] == 'ance' or word[-4:] == 'tion' or word[-4:] == 'sion' or word[-4:]=='ling' or word[-4:] == 'hood' or word[-4:] == 'ical' or word[-4:]=='some': 
			if word[:-4] in dictionary and word in unknowns:
				unknowns.remove(word)
			if word [:-4]+'e' in dictionary and word in unknowns:
				unknowns.remove(word)
			if word [:-3]+'e' in dictionary and word in unknowns:
				unknowns.remove(word)
		if word[-3:] == 'ing' or word[-3:] == 'dom' or word[-3:] == 'ize' or word[-3:] == 'ise' or word[-3:] == 'ism'or word[-3:] == 'ful' or word[-3:] == 'ish'or word[-3:] == 'ary'or word[-3:] == 'ate'or word[-3:] == 'ade' or word[-3:] == 'ity' or word[-3:] =='ies' or word[-3:]=='ves'or word[-3:] == 'ive' or word[-3:] == 'age' :
			if word[:-3]+'e' in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-3] in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-3]+'y' in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-3]+'f' in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-4]+'ze' in dictionary and word in unknowns:
				unknowns.remove(word)
		if word[-2:] == 'es' or word[-2:] == 'ly' or word[-2:] == 'en' or word[:2] =='ic' or word[-2:] == 'or' or word[-2:] == 'al' or word[-2:] == 'ed' or word[-2:] == 'er' or word[-2:] == 'ty' or word[-2:]=='ac':
			if word[:-2] in dictionary and word in unknowns:
				unknowns.remove(word)
			if word[:-2]+'e' in dictionary and word in unknowns:
				unknowns.remove(word)	
			if word[:-2]+'a' in dictionary and word in unknowns:
				unknowns.remove(word)
		if word [-1:] == 's' or word[-1:] == 'y' or word[-1:] == 'd' or word[-1:] == 'r':
			if word[:-1] in dictionary and word in unknowns:
				unknowns.remove(word)
		if word [:7] == 'counter':
			if word[7:] in dictionary and word in unknowns:
				unknowns.remove(word)
		if word [:6] == 'contra':
			if word[6:] in dictionary and word in unknowns:
				unknowns.remove(word)
		...
		if word[:1] == 'a' or word[:1] == 'e':
			if word[1:] in dictionary and word in unknowns:
				unknowns.remove(word)
		if word[-1:] == 'a':
			if word[:-1]+'um' in dictionary and word in unknowns:
				unknowns.remove(word)
